...
const ArreatsFace = new Unique(SlayerGuard, 'Arreat\s Face', 0);
...
const VerdungosHeartyCord = new Unique(MithrilCoil, 'Verdungo\s Heraty Cord', 0, 0);
...
const DurielsShell = new Unique(Cuirass, 'Duriel\s Shell', 0, 0);
...
const BloodRavensCharge = new Unique(MatriarchalBow, 'Blood Raven\s Charge', 0, 0);
...
const ReapersToll = new Unique(Thresher, 'Reaper\s Toll', 0, 0);
